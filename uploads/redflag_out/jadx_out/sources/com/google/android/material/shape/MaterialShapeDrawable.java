...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    protected void drawShape(Canvas canvas, Paint paint, Path path, RectF bounds) {
        drawShape(canvas, paint, path, this.drawableState.shapeAppearanceModel, this.springAnimatedCornerSizes, bounds);
    }
    ...
    private float calculateRoundRectCornerSize(RectF bounds, ShapeAppearanceModel shapeAppearanceModel, float[] cornerSizeOverrides) {
        ...
        if (MathUtils.areAllElementsEqual(cornerSizeOverrides) && shapeAppearanceModel.hasRoundedCorners()) {
    ...
    protected final void calculatePathForSize(RectF bounds, Path path) {
        this.pathProvider.calculatePath(this.drawableState.shapeAppearanceModel, this.springAnimatedCornerSizes, this.drawableState.interpolation, bounds, this.pathShadowListener, path);
    }
