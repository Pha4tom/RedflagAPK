...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    public MaterialButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (stateListShapeAppearanceModel == null) {
            shapeAppearanceModel = ShapeAppearanceModel.builder(context2, attrs, defStyleAttr, DEF_STYLE_RES).build();
        } else {
    ...
    private void updateIconPosition(int buttonWidth, int buttonHeight) {
        ...
        if (isIconStart() || isIconEnd()) {
            ...
            int availableWidth = ((((buttonWidth - getTextLayoutWidth()) - getPaddingEnd()) - localIconSize) - this.iconPadding) - getPaddingStart();
    ...
    private void maybeAnimateSize(boolean skipAnimation) {
        ...
        if (this.isInHorizontalButtonGroup) {
            int widthChange = Math.min(this.widthChangeMax, this.sizeChange.getSizeChangeForState(getDrawableState()).widthChange.getChange(getWidth()));
        ...
        if (this.opticalCenterEnabled != opticalCenterEnabled) {
            ...
            post(new Runnable() { // from class: com.google.android.material.button.MaterialButton$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    this.f$0.m158xa5042bf6();
                }
            });
        }
    }

    /* JADX INFO: renamed from: lambda$setOpticalCenterEnabled$0$com-google-android-material-button-MaterialButton, reason: not valid java name */
    /* synthetic */ void m157x61790e35(float diffX) {
        int opticalCenterShift = (int) (OPTICAL_CENTER_RATIO * diffX);
    ...
    /* JADX INFO: renamed from: lambda$setOpticalCenterEnabled$1$com-google-android-material-button-MaterialButton, reason: not valid java name */
    /* synthetic */ void m158xa5042bf6() {
