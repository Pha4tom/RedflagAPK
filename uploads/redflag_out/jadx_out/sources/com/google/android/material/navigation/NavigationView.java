...
public class NavigationView extends ScrimInsetsFrameLayout implements MaterialBackHandler {
    ...
    /* synthetic */ void m216xb790515(Canvas x$0) {
    ...
    private void setupInsetScrimsListener() {
        this.onGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.google.android.material.navigation.NavigationView.3
            ...
            public void onGlobalLayout() {
                ...
                NavigationView.this.setDrawLeftInsetForeground(isOnLeftSide && (!isRtl ? !NavigationView.this.isStartInsetScrimEnabled() : !NavigationView.this.isEndInsetScrimEnabled()));
