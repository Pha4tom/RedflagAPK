...
class MaterialCardViewHelper {
    ...
    public MaterialCardViewHelper(MaterialCardView card, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.iconFadeInAnimDuration = MotionUtils.resolveThemeDuration(this.materialCardView.getContext(), com.google.android.material.R.attr.motionDurationShort2, DEFAULT_FADE_ANIM_DURATION);
        this.iconFadeOutAnimDuration = MotionUtils.resolveThemeDuration(this.materialCardView.getContext(), com.google.android.material.R.attr.motionDurationShort1, DEFAULT_FADE_ANIM_DURATION);
    ...
    public void animateCheckedIcon(boolean checked) {
        ...
        this.iconAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.card.MaterialCardViewHelper$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m161xa4d79c2b(valueAnimator);
            }
        });
    ...
    /* synthetic */ void m161xa4d79c2b(ValueAnimator animation) {
