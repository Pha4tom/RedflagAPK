...
public final class BadgeState {
    ...
    BadgeState(Context context, int badgeResId, int defStyleAttr, int defStyleRes, State storedState) {
        ...
        state21.additionalHorizontalOffset = Integer.valueOf(iIntValue15);
        ...
        state22.additionalVerticalOffset = Integer.valueOf(iIntValue16);
        ...
        state23.autoAdjustToWithinGrandparentBounds = Boolean.valueOf(zBooleanValue);
        a.recycle();
