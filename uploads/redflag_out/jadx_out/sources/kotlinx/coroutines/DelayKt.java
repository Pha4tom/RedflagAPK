...
public final class DelayKt {
    ...
    */
    public static final java.lang.Object awaitCancellation(kotlin.coroutines.Continuation<?> r9) throws java.lang.Throwable {
        /*
    ...
    public static final Object delay(long timeMillis, Continuation<? super Unit> continuation) {
        ...
        if (timeMillis < Long.MAX_VALUE) {
            getDelay(cont.getContext()).mo1838scheduleResumeAfterDelay(timeMillis, cont);
        }
    ...
    public static final Object m1759delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1760toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m1760toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        boolean zM1626isPositiveimpl = Duration.m1626isPositiveimpl($this$toDelayMillis_u2dLRDsOJo);
        if (zM1626isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m1610getInWholeMillisecondsimpl(Duration.m1628plusLRDsOJo($this$toDelayMillis_u2dLRDsOJo, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM1626isPositiveimpl) {
