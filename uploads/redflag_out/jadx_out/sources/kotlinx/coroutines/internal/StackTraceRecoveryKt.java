...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM266constructorimpl2;
        ...
        try {
            ...
            objM266constructorimpl = Result.m266constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m269exceptionOrNullimpl(objM266constructorimpl) == null) {
            obj2 = objM266constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM266constructorimpl2 = Result.m266constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM266constructorimpl2 = Result.m266constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m269exceptionOrNullimpl(objM266constructorimpl2) == null) {
            obj = objM266constructorimpl2;
        }
