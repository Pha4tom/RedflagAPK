...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM266constructorimpl = Result.m266constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM266constructorimpl = Result.m266constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m272isFailureimpl(objM266constructorimpl)) {
                objM266constructorimpl = null;
            }
            return (E) objM266constructorimpl;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Throwable createConstructor$lambda$7$lambda$1(Constructor $constructor, Throwable e) throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Throwable createConstructor$lambda$7$lambda$3(Constructor $constructor, Throwable e) throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Throwable createConstructor$lambda$7$lambda$4(Constructor $constructor, Throwable e) throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Throwable createConstructor$lambda$7$lambda$6(Constructor $constructor, Throwable e) throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    public static final Throwable safeCtor$lambda$9(Function1 $block, Throwable e) {
        ...
        try {
            ...
            objM266constructorimpl = Result.m266constructorimpl(result);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM266constructorimpl = Result.m266constructorimpl(ResultKt.createFailure(th));
        }
        return (Throwable) (Result.m272isFailureimpl(objM266constructorimpl) ? null : objM266constructorimpl);
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM266constructorimpl = Result.m266constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM266constructorimpl = Result.m266constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m272isFailureimpl(objM266constructorimpl)) {
            objM266constructorimpl = numValueOf;
        }
        return ((Number) objM266constructorimpl).intValue();
    }
