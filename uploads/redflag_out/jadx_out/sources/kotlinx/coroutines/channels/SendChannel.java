...
public interface SendChannel<E> {
    ...
    Object mo1771trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1771trySendJP2dKIU(e);
            if (ChannelResult.m1796isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1790exceptionOrNullimpl = ChannelResult.m1790exceptionOrNullimpl(result);
