...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM266constructorimpl = Result.m266constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM266constructorimpl = Result.m266constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m272isFailureimpl(objM266constructorimpl) ? null : objM266constructorimpl);
