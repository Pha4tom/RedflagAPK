    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (true) {
            ...
            if (r0.isLayoutRTL() && r0.mOrientation == r9) {
                decoratedMeasurement2 = layoutParams.mFullSpan ? r0.mSecondaryOrientation.getEndAfterPadding() : r0.mSecondaryOrientation.getEndAfterPadding() - (((r0.mSpanCount - r9) - nextSpan.mIndex) * r0.mSizePerSpan);
        ...
        if (r0.mLayoutState.mLayoutDirection == -1) {
            maxEnd = r0.mPrimaryOrientation.getStartAfterPadding() - r0.getMinStart(r0.mPrimaryOrientation.getStartAfterPadding());
        } else {
            maxEnd = r0.getMaxEnd(r0.mPrimaryOrientation.getEndAfterPadding()) - r0.mPrimaryOrientation.getEndAfterPadding();
        }
