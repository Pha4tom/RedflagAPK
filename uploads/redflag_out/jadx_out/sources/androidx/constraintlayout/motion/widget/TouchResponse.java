        ...
        switch (event.getAction()) {
            ...
            case 2:
                ...
                if (Math.abs(drag) > this.mDragThreshold || this.mDragStarted) {
                    ...
                    float movmentInDir = (this.mTouchDirectionX * this.mAnchorDpDt[c3]) + (this.mTouchDirectionY * this.mAnchorDpDt[c2]);
                    if (Math.abs(movmentInDir * this.mDragScale) < 0.01d) {
                        this.mAnchorDpDt[c3] = 0.01f;
                        this.mAnchorDpDt[c2] = 0.01f;
                    }
                    if (this.mTouchDirectionX != 0.0f) {
                        change = dx / this.mAnchorDpDt[c3];
                    } else {
                        change = dy / this.mAnchorDpDt[c2];
                    }
                    ...
                    if (pos4 != current) {
                        if (current == 0.0f || current == 1.0f) {
                            this.mMotionLayout.endTrigger(current == 0.0f ? c2 : c3);
                        }
                        ...
                        if (this.mTouchDirectionX != 0.0f) {
                            velocity2 = tvx3 / this.mAnchorDpDt[c3];
                        } else {
                            velocity2 = tvy2 / this.mAnchorDpDt[c2];
                        }
