...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1750copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1752copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m1752copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m1597equalsimpl0(this.duration, timedValue.duration);
    }

    public int hashCode() {
        return ((this.value == null ? 0 : this.value.hashCode()) * 31) + Duration.m1620hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m1641toStringimpl(this.duration)) + ')';
    }
    ...
    public final long m1753getDurationUwyO8pc() {
        return this.duration;
    }
