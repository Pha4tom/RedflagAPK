...
public final class UnsignedKt {
    ...
    public static final int m618uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m361constructorimpl((int) ((((long) v1) & 4294967295L) % (4294967295L & ((long) v2))));
    }

    /* JADX INFO: renamed from: uintDivide-J1ME1BU, reason: not valid java name */
    public static final int m617uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m361constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m619ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m440constructorimpl(Long.compare(v1 ^ Long.MIN_VALUE, v2 ^ Long.MIN_VALUE) >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
            return ULong.m440constructorimpl(v1 / v2);
        }
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        return ULong.m440constructorimpl(((long) (Long.compare(ULong.m440constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m440constructorimpl(v2) ^ Long.MIN_VALUE) < 0 ? 0 : 1)) + quotient);
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m620ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
        ...
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        if (Long.compare(ULong.m440constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m440constructorimpl(v2) ^ Long.MIN_VALUE) >= 0) {
            j = v2;
        }
        return ULong.m440constructorimpl(rem - j);
    }
    ...
    private static final long uintToULong(int value) {
        return ULong.m440constructorimpl(((long) value) & 4294967295L);
    }
    ...
    public static final int doubleToUInt(double value) {
        ...
        return value <= 2.147483647E9d ? UInt.m361constructorimpl((int) value) : UInt.m361constructorimpl(UInt.m361constructorimpl((int) (value - ((double) Integer.MAX_VALUE))) + UInt.m361constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double value) {
        ...
        return value < 9.223372036854776E18d ? ULong.m440constructorimpl((long) value) : ULong.m440constructorimpl(ULong.m440constructorimpl((long) (value - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
