...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C00401<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C00401(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C00401> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00401 c00401 = new C00401(this.$this_ifEmpty, this.$defaultValue, continuation);
            c00401.L$0 = obj;
            return c00401;
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C00401(sequence, defaultValue, null));
    }
    ...
    static final class C00411<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00411(Sequence<? extends T> sequence, Random random, Continuation<? super C00411> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00411 c00411 = new C00411(this.$this_shuffled, this.$random, continuation);
            c00411.L$0 = obj;
            return c00411;
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            while (!mutableList.isEmpty()) {
                int iNextInt = c00411.$random.nextInt(mutableList.size());
                ...
                c00411.L$0 = sequenceScope;
                c00411.L$1 = mutableList;
                c00411.label = 1;
                if (sequenceScope.yield(objRemoveLast, c00411) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt.sequence(new C00411(sequence, random, null));
    }
    ...
    static final class C00361<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00361(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C00361> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00361 c00361 = new C00361(this.$source, this.$transform, this.$iterator, continuation);
            c00361.L$0 = obj;
            return c00361;
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            while (it.hasNext()) {
                Object next = it.next();
                Function2<Integer, T, C> function2 = c00361.$transform;
                int i2 = i + 1;
                if (i < 0) {
                    CollectionsKt.throwIndexOverflow();
                }
                Object objInvoke = function2.invoke(Boxing.boxInt(i), (T) next);
                c00361.L$0 = sequenceScope;
                c00361.L$1 = it;
                c00361.I$0 = i2;
                c00361.label = 1;
                if (sequenceScope.yieldAll(c00361.$iterator.invoke((C) objInvoke), c00361) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                i = i2;
            }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt.sequence(new C00361(source, transform, iterator, null));
    }
