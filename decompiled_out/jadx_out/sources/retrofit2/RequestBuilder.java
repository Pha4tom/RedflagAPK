...
import com.amz.apps.oe;
import com.amz.apps.s;
...
final class RequestBuilder {
    ...
    private static String canonicalizeForPath(String str, boolean z) {
        ...
        while (iCharCount < length) {
            ...
            if (iCodePointAt < 32 || iCodePointAt >= 127 || PATH_SEGMENT_ALWAYS_ENCODE_SET.indexOf(iCodePointAt) != -1 || (!z && (iCodePointAt == 47 || iCodePointAt == 37))) {
                le leVar = new le();
                leVar.writeUtf8(str, 0, iCharCount);
                canonicalizeForPath(leVar, str, iCharCount, length, z);
                return leVar.readUtf8();
            }
        ...
        while (i < i2) {
            ...
            if (!z || (iCodePointAt != 9 && iCodePointAt != 10 && iCodePointAt != 12 && iCodePointAt != 13)) {
                if (iCodePointAt < 32 || iCodePointAt >= 127 || PATH_SEGMENT_ALWAYS_ENCODE_SET.indexOf(iCodePointAt) != -1 || (!z && (iCodePointAt == 47 || iCodePointAt == 37))) {
                    ...
                    leVar2.writeUtf8CodePoint(iCodePointAt);
                    while (!leVar2.exhausted()) {
                        int i3 = leVar2.readByte() & 255;
                        leVar.writeByte(37);
                        char[] cArr = HEX_DIGITS;
                        leVar.writeByte((int) cArr[(i3 >> 4) & 15]);
                        leVar.writeByte((int) cArr[i3 & 15]);
                    }
                } else {
                    leVar.writeUtf8CodePoint(iCodePointAt);
                }
            }
    ...
    public void addHeader(String str, String str2) {
        ...
        try {
            ...
            throw new IllegalArgumentException(s.A("Malformed content type: ", str2), e);
        }
    }
    ...
    public void addPathParam(String str, String str2, boolean z) {
        ...
        if (PATH_TRAVERSAL.matcher(strReplace).matches()) {
            throw new IllegalArgumentException(s.A("@Path parameters shouldn't perform path traversal ('.' or '..'): ", str2));
        }
