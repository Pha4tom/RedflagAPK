...
abstract class HttpServiceMethod<ResponseT, ReturnT> extends ServiceMethod<ReturnT> {
    ...
    public static final class SuspendForBody<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
        ...
        public Object adapt(Call<ResponseT> call, Object[] objArr) {
            ...
            yo yoVar = (yo) objArr[objArr.length - 1];
            try {
                return this.isNullable ? KotlinExtensions.awaitNullable(callAdapt, yoVar) : KotlinExtensions.await(callAdapt, yoVar);
            } catch (Exception e) {
                return KotlinExtensions.suspendAndThrow(e, yoVar);
            }
        }
    }
    ...
    public static final class SuspendForResponse<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
        ...
        public Object adapt(Call<ResponseT> call, Object[] objArr) {
            ...
            yo yoVar = (yo) objArr[objArr.length - 1];
            try {
                return KotlinExtensions.awaitResponse(callAdapt, yoVar);
            } catch (Exception e) {
                return KotlinExtensions.suspendAndThrow(e, yoVar);
            }
        }
    ...
    public static <ResponseT, ReturnT> HttpServiceMethod<ResponseT, ReturnT> parseAnnotations(Retrofit retrofit, Method method, RequestFactory requestFactory) {
        ...
        if (typeResponseType == okhttp3.Response.class) {
            throw Utils.methodError(method, s.f(Utils.getRawType(typeResponseType), new StringBuilder("'"), "' is not a valid response body type. Did you mean ResponseBody?"), new Object[0]);
        }
