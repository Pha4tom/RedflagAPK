...
final class RxJava2CallAdapter<R> implements CallAdapter<R, Object> {
    ...
    public RxJava2CallAdapter(Type type, kk1 kk1Var, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7) {
    ...
    */
    public java.lang.Object adapt(retrofit2.Call<R> r2) {
        ...
        L1a:
            ...
            goto L18
        L24:
            com.amz.apps.kk1 r2 = r1.scheduler
            if (r2 == 0) goto L2c
            com.amz.apps.m21 r0 = r0.subscribeOn(r2)
        L2c:
            boolean r2 = r1.isFlowable
            if (r2 == 0) goto L37
            io.reactivex.BackpressureStrategy r2 = io.reactivex.BackpressureStrategy.LATEST
            com.amz.apps.u50 r2 = r0.toFlowable(r2)
            return r2
        L37:
            boolean r2 = r1.isSingle
            if (r2 == 0) goto L40
            com.amz.apps.eq1 r2 = r0.singleOrError()
            return r2
        L40:
            boolean r2 = r1.isMaybe
            if (r2 == 0) goto L49
            com.amz.apps.ws0 r2 = r0.singleElement()
            return r2
        L49:
            boolean r2 = r1.isCompletable
            if (r2 == 0) goto L52
            com.amz.apps.ll r2 = r0.ignoreElements()
            return r2
        L52:
            return r0
        */
