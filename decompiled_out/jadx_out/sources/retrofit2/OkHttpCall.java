...
import com.amz.apps.f70;
import com.amz.apps.le;
import com.amz.apps.pe;
import com.amz.apps.v51;
...
final class OkHttpCall<T> implements Call<T> {
    ...
    public static final class ExceptionCatchingResponseBody extends ResponseBody {
        ...
        private final pe delegateSource;
        IOException thrownException;

        public ExceptionCatchingResponseBody(ResponseBody responseBody) {
            this.delegate = responseBody;
            this.delegateSource = v51.buffer(new f70(responseBody.source()) { // from class: retrofit2.OkHttpCall.ExceptionCatchingResponseBody.1
                @Override // com.amz.apps.f70, com.amz.apps.jr1
                public long read(le leVar, long j) throws IOException {
                    try {
    ...
    @Override // retrofit2.Call
    public synchronized wz1 timeout() {
        try {
        } catch (IOException e) {
