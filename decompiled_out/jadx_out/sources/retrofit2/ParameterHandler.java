...
abstract class ParameterHandler<T> {
    ...
    public static final class FieldMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        public void apply(RequestBuilder requestBuilder, Map<String, T> map) throws IOException {
            ...
            for (Map.Entry<String, T> entry : map.entrySet()) {
                ...
                if (value == null) {
                    throw Utils.parameterError(this.method, this.p, bt0.e("Field map contained null value for key '", key, "'."), new Object[0]);
                }
    ...
    public static final class HeaderMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        public void apply(RequestBuilder requestBuilder, Map<String, T> map) throws IOException {
            ...
            for (Map.Entry<String, T> entry : map.entrySet()) {
                ...
                T value = entry.getValue();
                if (value == null) {
                    throw Utils.parameterError(this.method, this.p, bt0.e("Header map contained null value for key '", key, "'."), new Object[0]);
                }
    ...
    public static final class PartMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        public void apply(RequestBuilder requestBuilder, Map<String, T> map) throws IOException {
            ...
            for (Map.Entry<String, T> entry : map.entrySet()) {
                ...
                T value = entry.getValue();
                if (value == null) {
                    throw Utils.parameterError(this.method, this.p, bt0.e("Part map contained null value for key '", key, "'."), new Object[0]);
                }
                requestBuilder.addPart(okhttp3.Headers.of("Content-Disposition", bt0.e("form-data; name=\"", key, "\""), MIME.CONTENT_TRANSFER_ENC, this.transferEncoding), this.valueConverter.convert(value));
            }
        }
    }
    ...
    public static final class Path<T> extends ParameterHandler<T> {
        ...
        public void apply(RequestBuilder requestBuilder, T t) throws IOException {
            if (t == null) {
                throw Utils.parameterError(this.method, this.p, bt0.g(new StringBuilder("Path parameter \""), this.name, "\" value must not be null."), new Object[0]);
            }
    ...
    public static final class QueryMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        public void apply(RequestBuilder requestBuilder, Map<String, T> map) throws IOException {
            ...
            for (Map.Entry<String, T> entry : map.entrySet()) {
                ...
                T value = entry.getValue();
                if (value == null) {
                    throw Utils.parameterError(this.method, this.p, bt0.e("Query map contained null value for key '", key, "'."), new Object[0]);
                }
                String strConvert = this.valueConverter.convert(value);
                if (strConvert == null) {
