...
final class Utils {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return bt0.g(new StringBuilder(), Utils.typeToString(this.componentType), HttpUrl.PATH_SEGMENT_ENCODE_SET_URI);
        }
    }
    ...
    public static ResponseBody buffer(ResponseBody responseBody) throws IOException {
        le leVar = new le();
        responseBody.source().readAll(leVar);
        return ResponseBody.create(responseBody.contentType(), responseBody.contentLength(), leVar);
    }
    ...
    public static Type getParameterUpperBound(int i, ParameterizedType parameterizedType) {
        ...
        StringBuilder sbP = s.p("Index ", i, " not in range [0,");
    ...
    public static RuntimeException methodError(Method method, Throwable th, String str, Object... objArr) {
        StringBuilder sbH = bt0.h(String.format(str, objArr), "\n    for method ");
        sbH.append(method.getDeclaringClass().getSimpleName());
        sbH.append(".");
        sbH.append(method.getName());
        return new IllegalArgumentException(sbH.toString(), th);
    }

    public static RuntimeException parameterError(Method method, int i, String str, Object... objArr) {
        StringBuilder sbH = bt0.h(str, " (parameter #");
        sbH.append(i + 1);
        sbH.append(")");
        return methodError(method, sbH.toString(), objArr);
    }
    ...
    public static RuntimeException parameterError(Method method, Throwable th, int i, String str, Object... objArr) {
        ...
        sbH.append(i + 1);
        sbH.append(")");
        return methodError(method, th, sbH.toString(), objArr);
    }
